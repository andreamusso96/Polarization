...
class SimulationParameters:
    def __init__(self, sim_id: int, t: float, r: float, e: float, support: float, bin_size: float, boundary: float or None, d0_parameters: DistributionParameters, total_time_span: int, block_time_span: int, n_save_distributions_block: int, method: str):
        self.sim_id = sim_id
        self.t = t
        self.r = r
        self.e = e
